...
class ProductLocationScanner extends StatefulWidget {
  const ProductLocationScanner({Key? key}) : super(key: key);

  @override
  _ProductLocationScannerState createState() => _ProductLocationScannerState();
}

class _ProductLocationScannerState extends State<ProductLocationScanner> {
              ...
              actions: <Widget>[
                TextButton(
                    ...
                    onPressed: () {
                      ...
                      Globals.sourceLotNumber = lotNumber;
                    }
                )
              ],
            );
